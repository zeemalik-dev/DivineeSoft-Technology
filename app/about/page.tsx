    ...
    <div className="space-y-24 pb-24">
      ...
      <div>
        <PageHero
          title={
            <>
              About <span className="text-primary">DivineeSoft Technology</span>
            </>
          }
          ...
          <div className="space-y-24 relative">
            ...
            {processOverview.map((item, i) => {
              ...
              return (
                <div
                  key={i}
                  className={`flex flex-col ${i % 2 === 0 ? "lg:flex-row" : "lg:flex-row-reverse"} gap-12 lg:gap-20 items-center relative`}
                >
                  {/* Text Content */}
                  <div
                    className={`flex-1 space-y-6 ${i % 2 === 0 ? "lg:text-right lg:items-end" : "lg:text-left lg:items-start"} flex flex-col`}
                  >
                    <div
                      className={`flex items-center gap-4 mb-2 ${i % 2 === 0 ? "lg:flex-row-reverse" : "lg:flex-row"}`}
                    >
                      <div
                        className={`w-12 h-12 rounded-xl flex items-center justify-center text-white shadow-lg relative z-10 shrink-0 ${
                          i === 0
                    ...
                    <div
                      className={`bg-muted/50 rounded-xl p-6 border border-border/50 max-w-md ${i % 2 === 0 ? "self-end" : "self-start"}`}
                    >
                  ...
                  <div className="flex-1 relative w-full">
                    ...
                    <div
                      className={`absolute -z-10 w-[80%] h-[80%] rounded-full blur-3xl opacity-20 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ${
                        i === 0
                          ? "bg-emerald-500"
                          : i === 1
                            ? "bg-primary"
